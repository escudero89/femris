...
function getOptions(xnode, ielem, params) {
    ...
    var localParamsTextSVG = {          // These are the text's params shared locally
        ...
        'text-anchor'    : 'middle',
        'font-size'      :  textScaleFactor * Math.abs( xnode[ ielem[0][2] - 1 ][1] - xnode[ ielem[0][0] - 1 ][1] )
    };

    if (localParamsTextSVG['font-size'] === 0) {
        localParamsTextSVG['font-size'] = textScaleFactor * Math.abs( xnode[ ielem[0][1] - 1 ][1] - xnode[ ielem[0][0] - 1 ][1] );
    }
